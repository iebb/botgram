/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 471b527663b7cccd10290e000414b9dd)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	TELEGRAM_API_ROOT: "https://api.telegram.org";
	BOT_TOKEN: string;
	BOT_HUB: DurableObjectNamespace<import("./worker/index").BotHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BotHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TELEGRAM_API_ROOT" | "BOT_TOKEN">> {}
}
